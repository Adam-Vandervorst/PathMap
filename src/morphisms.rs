...
//GOAT, write this in terms of `into_cata_jumping_cached_fallible`
    ...
    ///
    /// See [into_cata_cached](CatamorphismCached::into_cata_cached) for explanation of other arguments and behavior
